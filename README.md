...
- Админка: пользователи, роли, активность, сброс пароля, системные настройки, параметры API, prompt template, health-check LM Studio, история запросов и ошибок модели, оценки ответов, журнал аудита.
...
### Локальный профиль MedGemma 27B
...
На текущем локальном запуске контрольный синтетический кейс обработан примерно за 82 секунды со скоростью около 7.4 output tok/s. Производительность зависит от компьютера, формата модели и настроек LM Studio.
